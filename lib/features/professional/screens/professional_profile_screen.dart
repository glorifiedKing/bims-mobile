...
class _ProfessionalProfileScreenState extends State<ProfessionalProfileScreen> {
  ...
  Future<void> _checkBiometricStatus() async {
    final enabled = await _biometricService.isProBiometricEnabled();
    if (mounted) {
      setState(() {
      ...
      body: BlocBuilder<ProfessionalProfileBloc, ProfessionalProfileState>(
        builder: (context, state) {
          if (state is ProfessionalProfileLoading ||
              state is ProfessionalProfileInitial) {
            return const Center(
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      _buildInfoCard(
                        ...
                        children: [
                          BlocBuilder<
                            ProfessionalDocumentsBloc,
                            ProfessionalDocumentsState
                          >(
                            builder: (context, docState) {
                              if (docState is ProfessionalDocumentsLoading ||
                                  docState is ProfessionalDocumentsInitial) {
                              ...
                              if (docState is ProfessionalDocumentsError) {
                                return Text(
                                  'Error loading documents: ${docState.message}',
                                  style: const TextStyle(
                          ...
                          onChanged: (val) async {
                            if (val) {
                              ...
                              if (auth) {
                                ...
                                if (token != null) {
                                  await _biometricService.enableProBiometric(token);
                              ...
                              await _biometricService.disableProBiometric();
